...
seed_products = [
  { name: "Wand", price: 50, merchant_id: 1, description: "Core of unicorn tail", photo_url: "http://vignette3.wikia.nocookie.net/harrypotter/images/a/ad/George_Weasley's_wand.jpg/revision/latest?cb=20110503105406", inventory: 100, retire: false, dimensions: "30, 40, 50", weight: 10 },
  { name: "Cauldron", price: 50, merchant_id: 3, description: "Solid. Made in Romania ", photo_url: "http://www.madvapes.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/c/a/cauldron.jpg", inventory: 24, retire: false, dimensions: "45, 55, 65", weight: 50 },
  { name: "Extendable Ears", price: 30, merchant_id: 2, description: "Sneak a listen at a distance", photo_url: "http://www.kimlawlercreative.com/wp-content/uploads/2011/06/extendable-ear.jpg", inventory: 20, retire: false, dimensions: "23, 34, 52", weight: 100 },
  { name: "Horcrux", price: 500000, merchant_id: 4, description: "A piece of the puzzle - the ring", photo_url: "http://ecx.images-amazon.com/images/I/41vRx1M8JTL._SY300_.jpg", inventory: 1, retire: true, dimensions: "32, 41, 35", weight: 3 },
  { name: "Firebolt 5", price: 1000, merchant_id: 6, description: "The finest of them all, the Firebolt 5 is faster than ever.", photo_url: "http://ii.wbshop.com/fcgi-bin/iipsrv.fcgi?FIF=/images/warnerbros/source/warnerbros/hpnbbroom.tif&wid=370&cvt=jpeg", inventory: 5, retire: false, dimensions: "55, 87, 11", weight: 1 },
  { name: "Bertie Bott's", price: 5, merchant_id: 5, description: "Delicious, disgusting treats for your friends and foes", photo_url: "http://cdn-tp1.mozu.com/9046-11441/cms/11441/files/35cdea6c-8cbb-490b-97d4-be3c2fc55840", inventory: 30, retire: false, dimensions: "66, 66, 66", weight: 30 },
  { name: "Cat", price: 500, merchant_id: 7, description: "She will purr in your lap and eat your rats", photo_url: "http://i.stack.imgur.com/dgcXv.png", inventory: 10, retire: false, dimensions: "11, 10, 5", weight: 55 },
  { name: "Dress Robe", price: 100, merchant_id: 8, description: "A desirable robe for your finest of occasion.", photo_url: "http://images.halloweencostumes.com/products/7538/1-2/replica-harry-potter-slytherin-robe.jpg", inventory: 10, retire: false, dimensions: "12, 34, 52", weight: 10 },
  { name: "Robe", price: 80, merchant_id: 8, description: "A desirable robe for everyday wear.", photo_url: "http://i684.photobucket.com/albums/vv208/lovexrwf/Wizard%20Robes/cloakseller_01/1.jpg", inventory: 10, retire: false, dimensions: "34, 45, 22", weight: 6 },
  { name: "Elder Wand", price: 80000, merchant_id: 1, description: "Straight from Dumbledore's tomb. Core of thestral hair.", photo_url: "http://vignette4.wikia.nocookie.net/harrypotter/images/7/7d/Elder_wand.jpg/revision/latest?cb=20110721103117", inventory: 10, retire: false, dimensions: "33, 21, 24", weight: 150 },
  { name: "Quill", price: 20, merchant_id: 3, description: "Durable, Made in Great Britain.", photo_url: "http://www.polyvore.com/cgi/img-thing?.out=jpg&size=l&tid=15030537", inventory: 10, retire: false, dimensions: "43, 45, 76", weight: 75 },
  { name: "Frog", price: 30, merchant_id: 7, description: "Get your first year a gift they're sure to misplace, time and time again..", photo_url: "http://internal.adu.org.za/upload/uploads/20120628_kznmidlands_commonriverfrog_trevor_hardaker.jpg", inventory: 10, retire: false, dimensions: "43, 25, 22", weight: 33 },
  { name: "Lemon Drops", price: 8, merchant_id: 5, description: "Dumbledore's favorite. Need we say more?", photo_url: "https://c2.staticflickr.com/2/1240/782790587_9c70da2bac.jpg", inventory: 100, retire: false, dimensions: "33, 81, 12", weight: 14 }
]
